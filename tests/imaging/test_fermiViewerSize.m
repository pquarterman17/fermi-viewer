...
%   Run via group :  runAllTests(Group="emgui")
    ...
    % ════════════════════════════════════════════════════════════════════
    % Current: 12,040 lines (2026-05-15). Pan feature added (+97 lines)
    % from 11,943 baseline. Workshop conversions + callback extractions
    % brought FV from 14,048 to 11,936 (-2,112 / -15%).
    ...
    % at 335, hard-stop at 340. Current FV is 310 + 10 = 320; ceiling
    % set to 321 to flag any new nested-fn additions. Doubly-nested
    % count is allowed to stay at 10 but should not grow.
    NESTED_FN_CEILING        = 321;
