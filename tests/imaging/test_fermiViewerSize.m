...
%   Run via group :  runAllTests(Group="emgui")
    ...
    % ════════════════════════════════════════════════════════════════════
    % Current: 11,721 lines (2026-05-15). buildMeasurementPanel extracted
    % (-239 lines). Workshop conversions + callback extractions brought FV
    % from 14,048 to 11,721 (-2,327 / -17%).
