...
%   Run via group :  runAllTests(Group="emgui")
    ...
    % ════════════════════════════════════════════════════════════════════
    % Current: 11,393 lines (2026-05-10). Workshop conversions + callback
    % extractions brought FV from 13,985 to 11,393 (-2,592 / -19%).
    ...
    % at 335, hard-stop at 340. Current FV is 309 + 12 = 321; ceiling
    % set to 322 to flag any new nested-fn additions. Doubly-nested
    % count is allowed to stay at 12 but should not grow.
    NESTED_FN_CEILING        = 322;
    DOUBLY_NESTED_CEILING    = 12;
