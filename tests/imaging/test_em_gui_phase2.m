%TEST_EM_GUI_PHASE2  Phase 2 test suite for emViewerGUI programmatic API.
%
%   Exercises the extended API surface introduced in Phase 2 of emViewerGUI:
...
try
    ...
    closeFiguresWithTag('emViewerEELS');
