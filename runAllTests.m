...
SUITES = {
    ...
    T('parser','test_ser_spectra'),                     'parser', 'SER 0x4120 spectra/spectrum images via synthetic fixtures: energy axis, cube orientation, survey, multi-frame warning'
    ...
    T('imaging','test_eels_model'),                     'eelsquant', 'EELS model-based multi-edge fit: joint background+edges, overlap separation, fixed-r map linearisation'
    ...
    T('imaging','test_fv_spectrumImage'),               'fvgui',  'EDS Spectrum Image workshop: window→map, pixel/ROI/sum spectra, element snap, CSV export, launch guards'
    ...
    T('imaging','test_eels_deconv'),                    'eels_adv', 'EELS deconvolution: Fourier-ratio plural-scattering removal + Richardson-Lucy'
