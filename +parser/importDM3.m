...
%IMPORTDM3  Import a Gatan DigitalMicrograph DM3 file.
...
%   Inputs
%   ──────
%   filepath   (1,1) string   Path to a .dm3 file.
%
%   Name-Value Options
%   ──────────────────
...
%   binary format. The file header specifies version 3 and data byte order.
%   Structural integers (counts, sizes) are always big-endian. Tag data
%   values follow the byte order flag in the header.
%
...
%   data = parser.importDM3('si_cube.dm3');
