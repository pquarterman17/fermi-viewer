...
%
%   Syntax
%     appData = fermiViewer.display.prepareDisplayBuffer(appData, ui)
%     appData = fermiViewer.display.prepareDisplayBuffer(appData, ui, pushToImage)
%     appData = fermiViewer.display.prepareDisplayBuffer(appData, ui, pushToImage, callbacks)
%
%   Inputs
