...
%
%   Syntax
%     appData = fermiViewer.display.displayHelpers('refresh',        appData, ctx)
%     appData = fermiViewer.display.displayHelpers('undoPop',        appData, ctx)
%     appData = fermiViewer.display.displayHelpers('rebuildAxes',    appData, ctx)
%     [appData, result] = fermiViewer.display.displayHelpers('lineProfile', appData, ctx, x1, y1, x2, y2)
%     appData = fermiViewer.display.displayHelpers('pixelInspector', appData, ctx, px, py)
%     appData = fermiViewer.display.displayHelpers('flickerTick',    appData, ctx)
%
%   Inputs
...
%   Examples
%     appData = fermiViewer.display.displayHelpers('refresh', appData, ctx);
%     [appData, r] = fermiViewer.display.displayHelpers('lineProfile', appData, ctx, 10, 20, 100, 80);
...
switch action
    ...
    % ────────────────────────────────────────────────────────────────────
    otherwise
        error('fermiViewer:display:displayHelpers:unknownAction', ...
