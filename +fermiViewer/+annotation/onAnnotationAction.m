...
%
% Syntax:
%   fermiViewer.annotation.onAnnotationAction(action, appData, ui, cb)
%   fermiViewer.annotation.onAnnotationAction(action, appData, ui, cb, arg1, ...)
%
% Inputs:
...
%
% Examples:
%   fermiViewer.annotation.onAnnotationAction('place', appData, ui, cb);
%   fermiViewer.annotation.onAnnotationAction('select', appData, ui, cb, 2);
