...
%
%   Syntax
%     appData = fermiViewer.interaction.mouseOps('motion',            appData, ctx)
%     appData = fermiViewer.interaction.mouseOps('idleDown',          appData, ctx)
%     appData = fermiViewer.interaction.mouseOps('axesDown',          appData, ctx)
%     appData = fermiViewer.interaction.mouseOps('buildContextMenus', appData, ctx)
%     appData = fermiViewer.interaction.mouseOps('buildContextMenu',  appData, ctx)
%
%   ctx fields (widgets)
...
switch action
    ...
    % ────────────────────────────────────────────────────────────────────
    otherwise
        error('fermiViewer:interaction:mouseOps:unknownAction', ...
