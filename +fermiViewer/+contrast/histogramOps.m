...
%   Syntax
%   ------
%   fermiViewer.contrast.histogramOps('update',   histAx, appData, ui, cb)
%   fermiViewer.contrast.histogramOps('click',    histAx, appData, ui, cb)
%   fermiViewer.contrast.histogramOps('startDrag',histAx, appData, ui, cb, which)
%   fermiViewer.contrast.histogramOps('markers',  histAx, appData, ui, cb)
%
%   Inputs
%   ------
...
%   varargin - optional arg for 'startDrag': which = 'lo'|'hi'|'bc'|'gamma'
    ...
    switch action
        ...
        case 'markers'
            ...
            fermiViewer.contrast.drawHistogramOverlay( ...
                histAx, ...
        ...
        otherwise
            warning('fermiViewer:contrast:histogramOps:unknownAction', ...
