...
%
%   fermiViewer.export.applyScaleBarPos(hBar, snap)
%
...
%       snap — 1x4 row vector from fermiViewer.export.snapScaleBarPos, or [] to skip
%              (no previous position to restore).
%
%   See also fermiViewer.export.snapScaleBarPos, imaging.addScaleBar.
