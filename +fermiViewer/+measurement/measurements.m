...
%   [arcX, arcY, midAngle, arcRadius] = fermiViewer.measurement.measurements('arcGeometry', pts, v1, v2)
%   totalDist = fermiViewer.measurement.measurements('polylineLength', pts, tiltDeg, tiltAxis, tiltGeom)
%   stats = fermiViewer.measurement.measurements('aggregateStats', measurementCellArray)
%
...
% Examples:
%   v1 = [10 0]; v2 = [0 10];
%   deg = fermiViewer.measurement.measurements('computeAngle', v1, v2, 0, 'Y', 'CrossSection')
%   % deg == 90
%
%   pts = [0 0; 3 0; 4 0];
%   dist = fermiViewer.measurement.measurements('polylineLength', pts, 0, 'Y', 'CrossSection')
%   % dist == 4  (3 + 1)
...
switch lower(action)
    ...
    otherwise
        error('fermiViewer:measurement:measurements:unknownAction', ...
