...
%
% Syntax
%   s = fermiViewer.measurement.buildMeasurementPanel(parent, palette, callbacks)
%
% Inputs
...
%
% Examples
%   s = fermiViewer.measurement.buildMeasurementPanel(pnlMeasure, palette, measCb_);
...
% ════════════════════════════════════════════════════════════════════════
    ...
    % Placeholder on a NUMERIC edit field is R2023a+; setting it in the
    % constructor errors on R2022b (the documented minimum). Set it after
    % construction, guarded, so R2022b just omits the cosmetic hint.
    if ~isMATLABReleaseOlderThan('R2023a')
        efScaleBarLen.Placeholder = 'auto';
    end
    ...
    btnExportToDP = uibutton(measureInnerGL, 'Text', 'Profile → BosonPlotter', ...
        ...
        'FontColor', palette.fg, ...
        'Enable', 'off', ...
        'Tooltip', 'Save line profile as CSV for BosonPlotter (import there with parser.importCSV)');
