...
%
% Syntax
%   t = fermiViewer.chrome.themePref('read')          % returns 'Dark' | 'Light' | 'Auto'
%   fermiViewer.chrome.themePref('write', 'Auto')     % persists choice
%
% 'Auto' means "follow OS appearance"; resolve via fermiViewer.chrome.resolveTheme
