...
%   BosonPlotter, test_em_gui_harness
    ...
    menuCb_ = struct( ...
        ...
        'onCropImage',@onCropImage, 'onZoomBox',@onZoomBox, 'onZoomActual',@onZoomActual, 'onZoomFit',@onZoomFit, ...
    ...
    %   Col 11 (28): Shortcuts (?)
    %   Col 12 (1x): Filename label
    toolbarGL = uigridlayout(rootGL, [1 12], ...
        'ColumnWidth', {80, 120, 55, 35, 35, 60, 35, 35, 32, 32, 28, '1x'}, ...
        'RowHeight',   {'1x'}, ...
        'Padding',     [4 2 4 2], ...
        'ColumnSpacing', 6);
    ...
    btnShortcuts.Layout.Row = 1; btnShortcuts.Layout.Column = 11; %#ok<NASGU>
