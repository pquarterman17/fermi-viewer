...
%   BosonPlotter, test_fv_gui_harness
    ...
    % ════════════════════════════════════════════════════════════════════
    statusGL = uigridlayout(rootGL, [1 6], ...
        'ColumnWidth', {110, 60, 100, '1x', 'fit', 'fit'}, ...
        'RowHeight',   {'1x'}, ...
        'Padding',     [6 0 6 0], ...
        'ColumnSpacing', 10);
    ...
    lblStatusMode = uilabel(statusGL, 'Text', '', ...
        'FontSize', 11, 'FontWeight', 'bold', ...
        'FontColor', [0.95 0.70 0.23], 'HorizontalAlignment', 'right');
    lblStatusMode.Layout.Row = 1; lblStatusMode.Layout.Column = 5;
    ...
    lblLoadStatus.Layout.Row = 1; lblLoadStatus.Layout.Column = 6;
