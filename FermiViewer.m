...
%   BosonPlotter, test_em_gui_harness
    ...
    btnZoomOut = uibutton(toolbarGL, 'Text', char(8722), ...
    ...
    toolbarGL = uigridlayout(axGL, [1 14], ...
        'ColumnWidth', {28, 28, 4, 28, 28, 4, 28, 28, 4, 28, 28, 4, 28, '1x'}, ...
        'RowHeight',   {28}, ...
        'Padding',     [2 2 2 2], ...
        'ColumnSpacing', 0);
    toolbarGL.Layout.Row = 1;
    ...
    % rotate(1,2) | flip(4,5) | zoom+fit(7,8) | reset+crop(10,11) | del-annot(13)
    tbCols = [1, 2, 4, 5, 7, 8, 10, 11, 13];
    ...
    function exitCompareMode()
        ...
        rcToolbarGL = uigridlayout(axGL, [1 14], ...
            'ColumnWidth', {28, 28, 4, 28, 28, 4, 28, 28, 4, 28, 28, 4, 28, '1x'}, ...
            'RowHeight',   {28}, ...
            'Padding',     [2 2 2 2], ...
            'ColumnSpacing', 0);
