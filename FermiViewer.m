...
%   BosonPlotter, test_fv_gui_harness
    ...
    %  every call so compareMode handle swaps (ax/stackGL) propagate.
        ui = struct('annotInnerGL', annotInnerGL, 'ax', ax, 'btn3DSurface', btn3DSurface, ...
            ...
            'btnAzIntegrate', btnAzIntegrate, 'btnBackProject', btnBackProject, ...
            ...
            'btnOverlayDiffRings', btnOverlayDiffRings, 'btnParticles', btnParticles, ...
            ...
            'btnWatershed', btnWatershed, 'btnZoomBox', btnZoomBox, 'btnZoomDims', btnZoomDims, ...
