...
%   BosonPlotter, test_em_gui_harness
    ...
    toolbarGL = uigridlayout(axGL, [1 12], ...
        'ColumnWidth', {32, 32, 6, 32, 32, 6, 32, 32, 6, 32, 32, '1x'}, ...
        'RowHeight',   {24}, ...
        'Padding',     [2 2 2 2], ...
        'ColumnSpacing', 0);
    toolbarGL.Layout.Row = 1;
    ...
    % Column mapping: groups of 2 separated by 6px spacers at cols 3,6,9
    % rotate(1,2) | flip(4,5) | zoom+fit(7,8) | reset+crop(10,11)
    tbCols = [1, 2, 4, 5, 7, 8, 10, 11];
    ...
    function exitCompareMode()
        ...
        rcToolbarGL = uigridlayout(axGL, [1 12], ...
            'ColumnWidth', {32, 32, 6, 32, 32, 6, 32, 32, 6, 32, 32, '1x'}, ...
            'RowHeight',   {24}, ...
            'Padding',     [2 2 2 2], ...
            'ColumnSpacing', 0);
